...
class CalculatorTests: XCTestCase {
    ...
    func testPercentage() {
        ...
        XCTAssertEqual(calculator.currentValue, 0.5, accuracy: 0.001)
    }
    ...
    func testClearFunctions() {
        calculator.inputNumber(123)
        calculator.clearEntry()
        XCTAssertEqual(calculator.currentValue, 0, accuracy: 0.001)
...
// MARK: - Test Runner (uncomment to run tests)
